...
input_csv = os.path.join(base_folder, "EGFP_CV_results.csv")
output_plot_folder = os.path.join(base_folder, "EGFP_CV_halfviolin_boxpoints_clean")
...
# --- Shared Y label ---
fig.supylabel("Coefficient of Variation (CV) of Nuclear GFP Signal ", fontsize=15, fontweight='bold', x=0.05)
